...
export function Hero() {
  return (
    <section className="mx-auto max-w-7xl px-4 pt-12 pb-32 sm:px-6 lg:px-8 relative border-b border-border/60">
      ...
      <div className="relative py-20 sm:py-32 overflow-hidden">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-8 space-y-8">
            ...
            <h1 className="text-5xl font-black tracking-tighter text-foreground sm:text-7xl xl:text-8xl leading-[0.9] uppercase flex flex-col">
          ...
          <div className="lg:col-span-4 lg:mt-16 space-y-10 border-l border-border/80 pl-6 lg:pl-8">
